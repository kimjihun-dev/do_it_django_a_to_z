...
class TestView(TestCase):
    ...
    def test_post_list(self):
        ...
        self.assertEqual('아직 게시물이 없습니다.', main_area.text)
        ...
        main_area = soup.find('div', id='main-area')
        self.assertEqual(post_001.title, main_area.text)
        self.assertEqual(post_002.title, main_area.text)
